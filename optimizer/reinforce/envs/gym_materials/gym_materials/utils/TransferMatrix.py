...
from MaterialFinder import MaterialLoader
...
class OpticalModeling(object):
    def __init__(self, Materials,
        ...
        self.material        = self.material_loader.load_select_material(self.material_li, WLrange[0], WLrange[1])

        # layers (materials)
        self.layers = self.material_loader.load_layers(self.material_li)
